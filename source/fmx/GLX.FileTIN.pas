  ...
  try
    ...
    begin
      ...
      begin
        ...
        if tl.Count = 9 then
        begin
          SetVector(v1, GLX.Utils.StrToFloatDef(tl[0], 0),
            GLX.Utils.StrToFloatDef(tl[1], 0),
            GLX.Utils.StrToFloatDef(tl[2], 0));
          SetVector(v2, GLX.Utils.StrToFloatDef(tl[3], 0),
            GLX.Utils.StrToFloatDef(tl[4], 0),
            GLX.Utils.StrToFloatDef(tl[5], 0));
          SetVector(v3, GLX.Utils.StrToFloatDef(tl[6], 0),
            GLX.Utils.StrToFloatDef(tl[7], 0),
            GLX.Utils.StrToFloatDef(tl[8], 0));
