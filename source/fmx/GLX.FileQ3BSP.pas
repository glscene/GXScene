...
procedure TgxQ3BSPVectorFile.LoadFromStream(aStream: TStream);
...
// ------------------------------------------------------------------
  ...
  RegisterVectorFileFormat('q3bsp', 'Quake3 BSP files', TgxQ3BSPVectorFile);

  // registering this extension too might be a little abusive right now...
  RegisterVectorFileFormat('bsp', 'BSP files', TgxQ3BSPVectorFile);
end.
