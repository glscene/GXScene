...
const
  cGLSLTypeString: array[TgxSLDataType] of AnsiString = (
    'undefined',
    'float',
    'vec2',
    'vec3',
  ...
  cGLSLSamplerString: array[TgxSLSamplerType] of AnsiString = (
    'undefined',
    'sampler1D',
    'sampler2D',
    'sampler3D',
...
const
  cGLgsInTypes : array[TgxgsInTypes] of GLenum =
    (GL_POINTS, GL_LINES, GL_LINES_ADJACENCY_EXT, GL_TRIANGLES,
     GL_TRIANGLES_ADJACENCY_EXT);
  cGLgsOutTypes: array[TgxgsOutTypes] of GLenum =
...
const
  cGLSLTypeComponents: array[TgxSLDataType] of Integer =
  (
    0,
    1,
    2,
  ...
  cGLSLTypeEnum: array[TgxSLDataType] of Integer =
  (
    0,
    GL_FLOAT,
    GL_FLOAT,
