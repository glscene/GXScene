...
begin
  raise Exception.Create
    ('GLX.Keyboard.IsKeyDown(c : Char) not yet implemented for your platform!');
end;
{$ENDIF}
...
{$ELSE}
    raise Exception.Create
      ('GLX.Keyboard.IsKeyDown(vk : TVirtualKeyCode) not fully yet implemented for your platform!');
{$ENDIF}
  end;
end;
...
begin
  raise Exception.Create
    ('GLX.Keyboard.KeyPressed not yet implemented for your platform!');
end;
{$ENDIF}
// ------------------------------------------------------------------
...
{$ELSE}
    raise Exception.Create
      ('GLX.Keyboard.VirtualKeyCodeToKeyName not yet fully implemented for your platform!');
{$ENDIF}
  end;
end;
...
begin
  ...
  if (Result = -1) and lExceptionWasRaised then
    raise Exception.Create
      ('GLX.Keyboard.KeyNameToVirtualKeyCode not yet fully implemented for your platform or keyName wasn''t found!');
end;
{$ENDIF}
...
{$ELSE}
  raise Exception.Create
    ('Scene.Keyboard.CharToVirtualKeyCode not yet implemented for your platform!');
{$ENDIF}
end;
