...
//
unit GLSLx.DiffuseSpecularShader;

(*
    This is a collection of GLSL Diffuse Specular shaders, comes in these variaties
              (to know what these suffixes and prefixes mean see GLX.CustomShader.pas):
...
type
  ...
  // Abstract class.
  TgxBaseCustomGLSLDiffuseSpecular = class(TgxCustomGLSLShader)
  private
    FLightPower: Single;
