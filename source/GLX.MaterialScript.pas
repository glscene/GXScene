...
begin
   ...
   if pos('(',val) > 0 then
   begin
      tmpcolor.Alpha := GLX.Utils.StrToFloatDef(copy(val, pos('(',val) + 1, pos(';',val) - 2));
      delete(val,1,pos(';',val));
      tmpcolor.Red := GLX.Utils.StrToFloatDef(copy(val, 1, pos(';',val) - 1));
      delete(val,1,pos(';',val));
      tmpcolor.Green := GLX.Utils.StrToFloatDef(copy(val, 1, pos(';',val) - 1));
      delete(val,1,pos(';',val));
      tmpcolor.Blue := GLX.Utils.StrToFloatDef(copy(val, 1, pos(')',val) - 1));
   end;
end;
...
begin
   ...
   if pos('(',val) > 0 then
   begin
      tmpcoords.X := GLX.Utils.StrToFloatDef(copy(val, pos('(',val) + 1, pos(';',val) - 2));
      delete(val,1,pos(';',val));
      tmpcoords.Y := GLX.Utils.StrToFloatDef(copy(val, 1, pos(';',val) - 1));
      delete(val,1,pos(';',val));
      tmpcoords.Z := GLX.Utils.StrToFloatDef(copy(val, 1, pos(')',val) - 1));
   end;
end;
...
begin
   ...
   if pos('(',val) > 0 then
   begin
      tmpcoords4.W := GLX.Utils.StrToFloatDef(copy(val, pos('(',val) + 1, pos(';',val) - 2));
      delete(val,1,pos(';',val));
      tmpcoords4.X := GLX.Utils.StrToFloatDef(copy(val, 1, pos(';',val) - 1));
      delete(val,1,pos(';',val));
      tmpcoords4.Y := GLX.Utils.StrToFloatDef(copy(val, 1, pos(';',val) - 1));
      delete(val,1,pos(';',val));
      tmpcoords4.Z := GLX.Utils.StrToFloatDef(copy(val, 1, pos(')',val) - 1));
   end;
end;
...
begin
   ...
   if extractvalue <> '' then
      NewMat.Material.Texture.ImageBrightness := GLX.Utils.StrToFloatDef(extractvalue);
end;
...
begin
   ...
   if extractvalue <> '' then
      NewMat.Material.Texture.ImageGamma := GLX.Utils.StrToFloatDef(extractvalue);
end;
...
begin
   ...
   if extractvalue <> '' then
      NewMat.Material.Texture.NormalMapScale := GLX.Utils.StrToFloatDef(extractvalue);
end;
...
begin
   ...
   begin
      ...
      // procedural noise not supported by GLX.Texture yet
   end;
end;
