...
//
unit GLX.MultiPolygon;

(* Object with support for complex polygons *)

(* TODO

  And I reactivated the TgxVectorPool object. The GLX.VectorLists are not suitable for this job.
...
type
  ...
  (* Multipolygon is defined with multiple contours.
     ...
     outline will be recalculated. The ouline in fact is a list of GLX.VectorLists. *)
